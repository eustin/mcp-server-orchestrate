# Orchestrator MCP Server — Gherkin Specifications

## Overview
Behavioral specification for the Python MCP server port of the OpenCode Orchestrator workflow.
Enforces a 4-phase machine-verified lifecycle: **DESIGN → PLAN → EXECUTE → VERIFY → COMPLETE** with human approval gates.
